...
$dados["descricao_acao"] = $_POST["txtDescricaoAcaoServicoSocial"];
$dados["sigiloso"] = (isset($_POST["chkSigilosoSs"]) AND $_POST["chkSigilosoSs"]==1) ? 1 : 0;
$dados["data_cadastro"] = normalizaDataAtendimento($_POST["txtDataAnotacaoServicoSocial"]);

$hash = md5($dados["data_cadastro"]);

$sistema = new Sistema();
//$sistema->debug=true;
$sistema->insert('rec_prontuario_servico_social',$dados);
