...
//$sistema->debug=true;
$campos = ' b.osc_razao_social , a.aco_nome , a.aco_dt_nasc , a.aco_rg , a.aco_cpf , a.aco_dt_entrada , a.aco_dt_saida , a.aco_status';
$from = 'acolhidos a';
$innerJoin[] = 'left join osc b on a.aco_osc = b.id';

$where = "aco_dt_entrada BETWEEN '2023-01-01 00:00:00' AND '2023-09-30 23:59:59'";
...
$escreve = fwrite($fp, "OSC;ACOLHIDO;NASCIMENTO;RG;CPF;ENTRADA;SAIDA;STATUS;FREQUENCIA$diaMesAno");
...
/*        
        ...
        if($dias_freq>91 OR $registro['aco_dt_saida']==""){
            $dias_marc = 91;
        }
        else{
            $dias_marc = $dias_freq;
...
*/
        ...
        $escreve = fwrite($fp, "\n$registro[osc_razao_social];$registro[aco_nome];$registro[aco_dt_nasc];$registro[aco_rg];$registro[aco_cpf];$data_inicial_freq;$data_saida_freq;$status;$dias_freq;$marcacao");
